...
class PKOnlyObject:
    """
    This is a mock object, used for when we only need the vacant_id of the object
    instance, but still want to return an object with a .vacant_id attribute,
...
class RelatedField(Field):
    ...
    def get_attribute(self, instance):
        if self.use_pk_only_optimization() and self.source_attrs:
            # Optimized case, return a mock object only containing the vacant_id attribute.
            try:
...
class PrimaryKeyRelatedField(RelatedField):
    default_error_messages = {
        ...
        'does_not_exist': _('Invalid vacant_id "{pk_value}" - object does not exist.'),
        'incorrect_type': _('Incorrect type. Expected vacant_id value, received {data_type}.'),
    }
...
class HyperlinkedRelatedField(RelatedField):
    ...
    def use_pk_only_optimization(self):
        return self.lookup_field == 'vacant_id'
    ...
    def get_url(self, obj, view_name, request, format):
        ...
        if hasattr(obj, 'vacant_id') and obj.pk in (None, ''):
            return None
...
class HyperlinkedIdentityField(HyperlinkedRelatedField):
    ...
    def use_pk_only_optimization(self):
        ...
        # to run the 'only get the vacant_id for this relationship' code.
        return False
...
class ManyRelatedField(Field):
    ...
    def get_attribute(self, instance):
        ...
        if hasattr(instance, 'vacant_id') and instance.pk is None:
            return []
