...
class BaseSchemaGenerator(object):
    ...
    # 'vacant_id' isn't great as an externally exposed name for an identifier,
    ...
    def coerce_path(self, path, method, view):
        ...
        if model:
            ...
            field_name = 'id'
        return path.replace('{vacant_id}', '{%s}' % field_name)
