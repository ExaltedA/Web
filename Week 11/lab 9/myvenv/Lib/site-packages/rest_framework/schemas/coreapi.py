...
class SchemaGenerator(BaseSchemaGenerator):
    ...
    def get_keys(self, subpath, method, view):
        ...
        /users/{vacant_id}/              ("users", "read"), ("users", "update"), ("users", "delete")
        /users/enabled/           ("users", "enabled")  # custom viewset list action
        /users/{vacant_id}/star/         ("users", "star")     # custom viewset detail action
        /users/{vacant_id}/groups/       ("users", "groups", "list"), ("users", "groups", "create")
        /users/{vacant_id}/groups/{vacant_id}/  ("users", "groups", "read"), ("users", "groups", "update"), ("users", "groups", "delete")
        """
        ...
        if is_custom_action(action):
            # Custom action, eg "/users/{vacant_id}/activate/", "/users/active/"
        ...
        # Default action, eg "/users/", "/users/{vacant_id}/"
        return named_path_components + [action]
